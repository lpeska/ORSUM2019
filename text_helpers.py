...
def normalize_text(texts, stops):
    ...
    # Remove stopwords
    texts = [' '.join([czech_stemmer.cz_stem(word) for word in x.split() if word not in (stops)]) for x in texts]
...
def load_slantour_data(data_folder_name, name= 'slantour_data.txt'):
